...
const sc_lv<16> kern_dec::ap_const_lv16_0 = "0000000000000000";
...
kern_dec::kern_dec(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_icmp_ln429_fu_2661_p2);
    sensitive << ( in_r_TVALID );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( icmp_ln100_fu_2639_p2 );
    sensitive << ( ap_predicate_op98_read_state1 );
    ...
    sc_trace(mVcdFile, icmp_ln429_fu_2661_p2, "icmp_ln429_fu_2661_p2");
    sc_trace(mVcdFile, icmp_ln429_reg_9904, "icmp_ln429_reg_9904");
