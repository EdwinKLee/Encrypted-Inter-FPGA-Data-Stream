...
void key_core_one::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvoutHandle << " , " <<  " \"timeStep_V_TDATA\" :  \"" << timeStep_V_TDATA.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"timeStep_V_TVALID\" :  \"" << timeStep_V_TVALID.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"timeStep_V_TREADY\" :  \"" << timeStep_V_TREADY.read() << "\" ";
